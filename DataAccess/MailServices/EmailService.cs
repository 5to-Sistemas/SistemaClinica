...
namespace DataAccess.MailServices
{
    public class EmailService
    {
        ...
        private readonly string Address = "proyectosistemaclinica@gmail.com";//Establece la dirección del correo servidor remitente(Aquí coloque el correo electrónico responsable de enviar los correos electrónicos).
        private readonly string Password = "b007sistemas";//Establece la contraseña del correo servidor remitente(Aquí coloque la contraseña del correo que estableciste en la linea anterior).
        private readonly string DisplayName = "Sistema Clinica";//Establece el nombre para mostrar cuando se envia un mensaje de correo.
        private readonly string Host = "smtp.gmail.com";//Establece el nombre o la dirección IP del host para las transacciones SMTP.
