...
namespace Presentation
{
    public partial class MainForm : BaseForms.BaseMainForm
    {
        ...
        {//Administrar los permisos de usuario, esto es simplemente una demostración,
            ...
            switch (ActiveUser.Position)
            {
                ...
                /*case Positions.Enfermera:
                    ...
                    break;
                case Positions.AsistenteAdministrativo:
                    btnReports.Enabled = false;
                    break;
                case Positions.Recepsionista:
                    btnReports.Enabled = false;
                    btnUsers.Enabled = false;
                    break;
                case Positions.GerenteDeRecursosHumanos:

                    break;
                case Positions.Paciente:

                    break;*/
                case Positions.AdministradorDeSistema:
        ...
        {
            OpenChildForm<FormPacients>(sender);
        }

        private void btnHistory_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormHistory>(sender);
        }

        private void btnCalendar_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormCitaMedica>(sender);
        }

        private void btnReports_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormReports>(sender);
        }
        private void btnDoctors_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormMedical>(sender);
        }
        private void btnDashboard_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormDashboard>(sender);
        }
        #endregion
