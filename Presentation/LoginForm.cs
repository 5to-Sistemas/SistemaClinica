    ...
    public partial class LoginForm : Form
    {
        ...
        {//Iniciar sesión
            ...
            if (userModel != null)//Si el inicio de sesión fue exitosa.
            {
                ...
                //insertar condiciones en if
                /*ActiveUser.Position == Positions.Enfermera
                    || ActiveUser.Position == Positions.AsistenteAdministrativo ||*/
                if (ActiveUser.Position == Positions.Medico || ActiveUser.Position == Positions.AdministradorDeSistema)
                {
                ...
                else if (ActiveUser.Position == Positions.Enfermera)
                {
                    mainForm = new ChildForms.FormHistory();
                }
                else if (ActiveUser.Position == Positions.Paciente)
                {
                    mainForm = new ChildForms.FormCitaMedica();//solo citas medicas
                }
                else
                {
                    mainForm = null;
